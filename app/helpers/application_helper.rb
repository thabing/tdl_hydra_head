module ApplicationHelper
  ...
  def disseminator_link pid, datastream_name
    raw "<a class=\"fbImage\" href=\"#{ datastream_disseminator_url(pid, datastream_name) }\">view</a>"
  end
  ...
  def datastream_disseminator_url pid, datastream_name
    ...
    raw "#{base_url}/get/#{pid}/#{datastream_name}"
  end


  def get_google_docs_iframe pid, datastream_name
    raw "<iframe src=\"http://docs.google.com/viewer?url=http://dl.dropbox.com/u/43822/tufts-UA005.036.001.00001.pdf&embedded=true\" width=\"600\" height=\"780\" style=\"border: none;\"></iframe>"
  end
